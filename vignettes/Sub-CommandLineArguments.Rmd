...
**Tfirst**
Tfirst is the time of first observation for steady-state data. If the *doseType* argument is assigned to "ss" and Tfirst is *NULL*, steady state observation period will be estimated based on the first non-zero obverved concentration and Tau. The default value to this argument is ***NULL***.
