...
-
-
^\* Acharya, C., Hooker, A. C., Türkyılmaz, G. Y., Jönsson, S., Karlsson, M. O., A diagnostic tool for population models using non-compartmental analysis: The ncappc package for R, *Computer Methods and Programs in Biomedicine*, 2016, Vol. 127, 83-93
...
print(xtable(prnTab1, align=rep("c",ncol(prnTab1)+1), rotate.colnames = T), include.rownames=FALSE, type = 'html')
```
...
```{r concplot, echo=FALSE, fig.height=5, fig.width=9, fig.align='center', dpi=60}
if (length(conc)>0){
...
```{r histobsplot, echo=FALSE, fig.height=14, fig.width=12, fig.align='center', dpi=45}
if (length(histobs)>0){
...
```{r popplot, echo=FALSE, fig.height=14, fig.width=12, fig.align='center', dpi=45}
if (length(pop)>0){
...
```{r devplot, echo=FALSE, fig.height=14, fig.width=12, fig.align='center', dpi=45}
if (length(dev)>0){
...
```{r outlierplot, echo=FALSE, fig.height=14, fig.width=12, fig.align='center', dpi=45}
if (length(outlier)>0){
  suppressPackageStartupMessages(require(gridExtra))
...
```{r histnpdeplot, echo=FALSE, fig.height=14, fig.width=12, fig.align='center', dpi=45}
...
```{r forestplot, echo=FALSE, fig.height=14, fig.width=15, fig.align='center', dpi=45}
if (length(forest)>0){
...
```{r npdeplot, echo=FALSE, fig.height=14, fig.width=12, fig.align='center', dpi=45}
if (length(npde)>0){
