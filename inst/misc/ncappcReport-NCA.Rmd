...
print(xtable(prnTab1, align=rep("c",ncol(prnTab1)+1), rotate.colnames = T), include.rownames=FALSE, type = 'html', size="\\fontsize{8pt}{8pt}\\selectfont")
```
...
```{r plot, echo=FALSE, fig.height=5, fig.width=9, fig.align='center', dpi=60}
if (length(conc)>0){
