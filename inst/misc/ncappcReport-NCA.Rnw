...
if(case==1) colform <- c(rep("p{1cm}",1),rep("p{2.5cm}",ncol(pddf)))
if(case==2) colform <- c(rep("p{1cm}",2),rep("p{2.5cm}",ncol(pddf)-1))
if(case==3) colform <- c(rep("p{1cm}",3),rep("p{2.5cm}",ncol(pddf)-2))
if(case==4) colform <- c(rep("p{1cm}",4),rep("p{2.5cm}",ncol(pddf)-3))
