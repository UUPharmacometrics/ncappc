...
\title{\textbf{Report of \textit{ncappc} package}}
...
sprtxt   <- ifelse(spread=="sd", "standard deviation", "95% nonparametric prediction interval of the NCA metrics obtained from the simulated data")
@
