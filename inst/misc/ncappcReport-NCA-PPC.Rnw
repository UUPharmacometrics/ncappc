...
<<concplot, echo=FALSE, fig.pos="H", out.width='0.9\\textwidth', fig.align="center">>=
if (length(conc)>0){
...
<<histobsplot, echo=FALSE, fig.pos="H", out.width='0.9\\textwidth', fig.align='center'>>=
if (length(histobs)>0){
...
<<popplot, echo=FALSE, fig.pos="H", fig.height=8, fig.width=4, out.width='0.9\\textwidth', fig.align='center'>>=
if (length(pop)>0){
  suppressPackageStartupMessages(require(gridExtra))
...
<<devplot, echo=FALSE, fig.pos="H", out.width='0.9\\textwidth', fig.align='center'>>=
if (length(dev)>0){
...
<<outlierplot, echo=FALSE, fig.pos="H", out.width='0.9\\textwidth', fig.align='center'>>=
if (length(outlier)>0){
  suppressPackageStartupMessages(require(gridExtra))
...
<<forestplot, echo=FALSE, fig.pos="H", out.width='0.9\\textwidth', fig.align='center'>>=
if (length(forest)>0){
...
<<npdeplot, echo=FALSE, fig.pos="H", out.width='0.9\\textwidth', fig.align='center'>>=
if (length(npde)>0){
...
<<histnpdeplot, echo=FALSE, fig.pos="H", out.width='0.9\\textwidth', fig.align='center'>>=
