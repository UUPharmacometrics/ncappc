...
<<MAINknitr,cache=FALSE,message=FALSE,comment=NA,warning=FALSE,echo=FALSE,results='hide'>>=
...
\vfill
\textsuperscript{*} Acharya, C., Hooker, A. C., Türkyılmaz, G. Y., Jönsson, S., Karlsson, M. O.; A diagnostic tool for population models using non-compartmental analysis: The ncappc package for R, \textit{Computer Methods and Programs in Biomedicine}, 2016, Vol. 127, 83-93
\clearpage
...
<<txt, echo=FALSE, tidy=TRUE, results='markup'>>=
cat(txt)
@
\paragraph{}
...
<<concplot, echo=FALSE, fig.pos="H", fig.height=6, fig.width=12, out.width='0.8\\textwidth', fig.align="center">>=
if (length(conc)>0){
...
<<histobsplot, echo=FALSE, fig.pos="H", fig.height=16, fig.width=14, out.width='0.8\\textwidth', fig.align='center'>>=
if (length(histobs)>0){
...
<<popplot, echo=FALSE, fig.pos="H", fig.height=18, fig.width=18, out.width='1\\textwidth', fig.align='center'>>=
if (length(pop)>0){
  suppressPackageStartupMessages(require(gridExtra))
...
<<devplot, echo=FALSE, fig.pos="H", fig.height=14, fig.width=12, out.width='0.8\\textwidth', fig.align='center'>>=
if (length(dev)>0){
...
<<outlierplot, echo=FALSE, fig.pos="H", fig.height=14, fig.width=12, out.width='0.8\\textwidth', fig.align='center'>>=
if (length(outlier)>0){
  suppressPackageStartupMessages(require(gridExtra))
...
<<histnpdeplot, echo=FALSE, fig.pos="H", fig.height=14, fig.width=12, out.width='0.8\\textwidth', fig.align='center'>>=
...
<<forestplot, echo=FALSE, fig.pos="H", fig.height=14, fig.width=15, out.width='1\\textwidth', fig.align='center'>>=
if (length(forest)>0){
...
<<npdeplot, echo=FALSE, fig.pos="H", fig.height=14, fig.width=12, out.width='0.8\\textwidth', fig.align='center'>>=
if (length(npde)>0){
